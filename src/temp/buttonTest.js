...
const ping = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      console.log(e);
      await interaction.reply({ content: 'Uh oh, something has gone wrong while trying to get some questions. Please try again' });
      return;
    }
    ...
    const msg = await interaction.reply({ content: 'This is my question', components: [row] });


    const collector = interaction.channel.createMessageComponentCollector({ componentType: 2, time: 15000 });
    const answers = {}
